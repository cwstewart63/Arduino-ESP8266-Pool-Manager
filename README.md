...
Note: the design uses M3 x 5mm brass inserts. 4 for the bezel, 4 for the base. Enclosure is sized to fit additional Modus Master PCB board which is the same size as the display using 3mm standoffs.
